...
1. After the serve, the ball **must bounce** in the receiver's court.
2. The receiver returns it, and the ball **must bounce again** in the server's court.
3. From then on (after those two bounces), you can hit the ball in the air (volley) or let it bounce.
